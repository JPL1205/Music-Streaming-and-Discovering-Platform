...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#000000] border-r border-gray-200/30">
        <img src={icon} alt="logo" className="w-16 h-16 object-contain -mt-4" />
        <NavLinks />
      </div>
